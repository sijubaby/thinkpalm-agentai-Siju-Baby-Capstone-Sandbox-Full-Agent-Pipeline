...
| 0:45–1:30 | Architecture diagram: 3 agents, memory (`runs/`), 4 tools |
...
| 7:00–8:00 | Run AIS domain or show `samples/ais-*.md`; GitHub link |
...
qa-agent run -s samples/crew-certification-expiry-alerts.md -d crew-cert -o out/demo
start out/demo/coverage-report.html
